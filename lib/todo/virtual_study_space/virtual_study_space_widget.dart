...
class _VirtualStudySpaceWidgetState extends State<VirtualStudySpaceWidget>
  ...
  void initState() {
    ...
    _model.todoItemTextController ??= TextEditingController();
    _model.todoItemFocusNode ??= FocusNode();

    _model.todoDescriptionTextController ??= TextEditingController();
    _model.todoDescriptionFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 12.0, 0.0, 24.0),
                                child: Text(
                                  'Enter the tasks you wish to do today.',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  width: double.infinity,
                                  child: TextFormField(
                                    controller: _model.todoItemTextController,
                                    focusNode: _model.todoItemFocusNode,
                                    autofocus: true,
                                    ...
                                    minLines: 1,
                                    validator: _model
                                        .todoItemTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.todoDescriptionTextController,
                                    focusNode: _model.todoDescriptionFocusNode,
                                    autofocus: true,
                                    autofillHints: const [AutofillHints.name],
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      onPressed: () async {
                                        await TodoRecord.collection
                                            ...
                                            .set(createTodoRecordData(
                                              taskName: _model
                                                  .todoItemTextController.text,
                                              taskDeadline: _model.datePicked,
                                              taskDescription: _model
                                                  .todoDescriptionTextController
                                                  .text,
                                              taskCreator:
